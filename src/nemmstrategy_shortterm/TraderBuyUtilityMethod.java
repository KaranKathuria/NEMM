/*
 * Version info:
 *    Set as a copy of OPAutilitymethod just to change one simple variable in line 171.
 *	
 *	Created 20150630
 */
...
//Class definition
public class TraderBuyUtilityMethod extends GenericUtilityMethod{
	...
	// Constructor
	public TraderBuyUtilityMethod(int functionFlag) {
	...
	private ArrayList<double[]> UtilFctn_ExpReturn(double priceSpot, ArrayList<BidOffer> s, double shareofmarginaltoffersold) {
		...
		//	certValue[i]=priceSpot; // for now, take the market price as the best guess of the certificate value
			certValue[i]=myAgent.getagentcompanyanalysisagent().getmarketanalysisagent().getCertValueTrader();
		}
