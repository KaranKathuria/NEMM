/*
 * Version info:
 *     Set as a copy of PAutilitymethod just to change one simple variable in line 171.
 *      *	Created 20150630
 */
...
public class TraderSellUtilityMethod extends GenericUtilityMethod{
	...
	// Constructor
	public TraderSellUtilityMethod(int functionFlag) {
...
//				curOfferShareCleared = s.get(i).getShareCleared();
				...
				if (curOfferVol > 0) {
					...
					if (i==0) {
						...
						certValue=myAgent.getagentcompanyanalysisagent().getmarketanalysisagent().getCertValueTrader();
