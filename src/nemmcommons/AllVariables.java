...
public class AllVariables {
	...
	public static double bankPAfirstrealtick =   8400000;		// public static double bankPAfirstrealtick =   10400000;//11700000;//10400000;//8302000;//	//Bank at thefirstrealtick. If tick 0 this should be 8800 000. For memo Dec 2014, 10500000 was used.  2014: 8302000
...
//	public static double OPAgentmustsellshare = 0.75; 		 //RandomHelper.nextDoubleFromTo(0.4,0.6); //0.5;
	...
	public static double[] cutoffPAExit = new double[]{0.2,0.4,0.65,1.0};	//{0.19,0.6,0.7,1.0};	//Last increasse the end. Middel increses the level, the first tend to give "correct" prices earlier.
